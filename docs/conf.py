# -*- coding: utf-8 -*-
#
# pytest-mpi-check documentation build configuration file, created by
...
project = 'pytest-mpi-check'
copyright = '2015, Bruno Maugars'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-mpi-check Documentation',
     [author], 1)
]
