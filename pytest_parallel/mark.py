  ...
  """
    ...
    Details
      What is subtle here is that 'comm' means 3 different things
        - the first 'comm' is a "call_spec"
        - the second 'comm' (in indirect) is a "fixture",
      ...
      What happens is that:
        ...
        - this info will be passed to `pytest_parallel.pytest_collection_modifyitems` that will create a communicator
